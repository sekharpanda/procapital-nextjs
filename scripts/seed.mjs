...
const articles = JSON.parse(
  fs.readFileSync(path.join(__dirname, '../src/seed/content.json'), 'utf8'),
)

async function upsertPage(payload, data) {
...
async function run() {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      guideDisclaimer:
        "This guide is general information about Dubai's published mortgage rules and current market practice as of July 2026 — not legal or financial advice. LTV caps, rates, fees and lender criteria change and vary by bank. Figures shown are indicative and subject to lender approval and property valuation.",
    },
  })
    ...
    faqs: [
      {
        ...
        answer:
          'Yes. Non-residents can secure a mortgage in Dubai. Most banks require six months of bank statements, proof of income and a passport copy. We work with the banks most favourable to non-resident applicants.',
      },
      {
        question: 'How much deposit do I need for a mortgage in Dubai?',
        answer:
          'UAE residents typically need a 20% down payment for a first property under AED 5 million. Non-residents usually need 20 to 25%. We help you plan for the deposit plus fees before you commit.',
      },
      {
        question: 'Does ProCapital charge for its service?',
        answer:
          'Your initial consultation and mortgage comparison are free. We are paid by the bank on completion, and we always disclose any fees upfront.',
      },
      {
        question: 'How long does mortgage pre-approval take?',
        answer:
          'With complete documents, pre-approval typically takes 3 to 5 working days. We prepare and package your file so it is approved first time.',
      },
      {
  ...
  await upsertPage(payload, {
    ...
    metaKeywords: 'equity release Dubai, cash out refinance Dubai, loan against property Dubai',
    canonicalPath: '/equity-release-dubai',
    heroTitle: 'Equity Release in Dubai: The 2026 Guide',
    heroLede:
      "If your Dubai property has grown in value, that gain is real money you can access — without selling. Here's exactly how equity release works in 2026, what you can release, and how long it takes.",
    ...
    faqs: [
      {
        question: 'Can I release equity from my property in Dubai?',
        answer:
          'Yes. If you own a property in Dubai that has built up equity, you can release a lump sum of cash against its value, usually by refinancing.',
      },
      {
        question: 'How much equity can I release in Dubai?',
        answer:
          'For residents, banks typically allow up to 70-75% LTV; for non-residents, around 50-60%. Your releasable equity is the difference between that ceiling and what you still owe.',
      },
      {
        question: 'How long does equity release take in Dubai?',
        answer: 'Typically around 2-4 weeks, depending on the lender, valuation and documentation.',
      },
    ],
  })
  ...
  await upsertPage(payload, {
    ...
    metaDescription:
      'How much salary you need, deposit, LTV and rates for a resident mortgage in Dubai in 2026. Eligibility, costs and the step-by-step process.',
    metaKeywords: 'resident mortgage Dubai, home loan Dubai, mortgage eligibility Dubai',
    canonicalPath: '/mortgage-for-residents-dubai',
    heroTitle: 'Mortgage for Residents in Dubai: The 2026 Guide',
    heroLede:
      'Salary requirements, deposit, LTV caps and the step-by-step process for UAE residents buying in Dubai — explained without the jargon.',
    heroUpdated: 'Last reviewed July 2026 · Written by ProCapital mortgage advisors',
    ...
    faqs: [
      {
        ...
        answer:
          'Most UAE banks require around AED 10,000 to AED 15,000 monthly income. Your Debt Burden Ratio (50% cap) often matters more than the minimum.',
      },
      {
        question: 'How much deposit do I need as a resident?',
        answer:
          'Resident expats need 20% on a first property under AED 5 million (30% above). UAE nationals need 15%.',
      },
    ],
  })
  ...
  await upsertPage(payload, {
    ...
    metaDescription:
      'How off-plan mortgages work in Dubai in 2026: the 50% LTV cap, construction milestones, rates from 4.49%, eligibility and approved developers.',
    metaKeywords: 'off plan mortgage Dubai, financing off plan property Dubai',
    canonicalPath: '/off-plan-mortgage-dubai',
    heroTitle: 'Off-Plan Mortgage in Dubai: The 2026 Guide',
    heroLede:
      'The 50% LTV rule, when the bank actually pays, current rates and which developers are approved — plain English for 2026 buyers.',
    heroUpdated: 'Last reviewed July 2026 · Written by ProCapital mortgage advisors',
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, on approved developer projects, capped at 50% LTV. The bank releases funds in stages as construction progresses.',
      },
      {
        question: 'What is the maximum LTV on off-plan property?',
        answer: 'The UAE Central Bank caps off-plan financing at 50% loan-to-value for all nationalities.',
      },
    ],
  })
